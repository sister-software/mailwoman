...
- **Smokes must match full-run effective batch.** Smoke at eff_batch=8 passed; full at eff_batch=128 diverged. Added to [`VERDICT_SMOKES.md`](docs/engineering/reference/VERDICT_SMOKES.md).
