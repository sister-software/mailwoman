...
| --- | --- | --- | --- | --- |
| **4.4.0** (current) | 2026-06-11 | `v1.3.0-boundary-consolidation` @ 40k (from scratch) | **The boundary consolidation**: po_box 0→89.1, cedex 0→96.1, intersections 0→100 (the last starved tags), perturb arena 64→72 (the #513 debt, gated), FR region 16.2→25.6. Ships the span bridge (required decode config; dotted surfaces are corpus-unlabelable). PASS 17/17 on the densest pre-registered spec to date; three-battery verdict record. | [v4.4.0 ship gate](./evals/2026-06-11-v4.4.0-ship-gate.md) |
