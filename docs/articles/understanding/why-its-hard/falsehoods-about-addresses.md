...
| Precision | [Falsehoods about geocoded precision and frontages](./falsehoods-proximity.md) | Not one correct coordinate, not always "close enough," not the front door                  |
...
- [How mail delivery actually works](../the-problem/how-mail-delivery-works.md) — the system these falsehoods enter
