...
This is the most common architecture: call Google/geocode.earth for the 90% that parses cleanly, fall back to manual review for the 10% that doesn't. But the fallback cost dominates the total.
...
- [How mail delivery actually works](../the-problem/how-mail-delivery-works.mdx) — the system that already handles ambiguity through human fallback
