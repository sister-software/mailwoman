...
- [How mail delivery actually works](../the-problem/how-mail-delivery-works.md) — the system that doesn't need a perfect database either
...
- [What is an address?](../the-problem/what-is-an-address.md) — the data model these databases attempt to capture
