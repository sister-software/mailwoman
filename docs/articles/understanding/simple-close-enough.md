...
- [Falsehoods about geocoded precision and frontages](./falsehoods-proximity.md) — the precision assumptions that break geocoders
- [The 90% trap](./the-90-percent-trap.md) — why the 10% tail costs more than the 90%
