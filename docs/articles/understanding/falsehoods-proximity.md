...
- [How can a building have two addresses?](./how-can-a-building-have-two-addresses.md) — why a building has multiple correct coordinates
- [How mail delivery actually works](./how-mail-delivery-works.md) — the delivery chain that consumes these coordinates
