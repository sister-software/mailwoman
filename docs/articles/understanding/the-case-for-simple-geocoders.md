...
- [Why a neural parser?](./why-a-neural-parser.md) — the affirmative case
- [The 90% trap](./the-90-percent-trap.md) — the economic argument for going past 90%
- [Falsehoods about addresses](./falsehoods-about-addresses.md) — the counterexamples that break simple architectures
