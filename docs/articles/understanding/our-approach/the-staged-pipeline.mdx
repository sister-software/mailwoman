...
- Language-switch hybrids ([#7](../why-its-hard/addresses-that-break-geocoders.mdx#7-language-switch-hybrids)) — when the input mixes scripts, the gate either picks a hybrid-trained weights package or falls back to a multi-locale ensemble.
...
- [Implementation plan](../../plan/README.mdx) — phase-by-phase development plan
