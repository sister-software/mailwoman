...
This section is a roadmap snapshot from the training-stability crisis of May 2026, superseded by everything that has shipped since. For current state, see [the scope declaration](../../plan/SCOPE.mdx) and [Releases & capabilities](../../releases.mdx). Kept for the historical record.
