...
- [The staged pipeline](./the-staged-pipeline.md) — the Mailwoman runtime in detail
- [The knowledge ladder](./the-knowledge-ladder.md) — the principle behind the decomposition
- [How it used to work](./how-it-used-to-work.md) — the traditional Mailwoman v1 pipeline
- [How it works now](./how-it-works-now.md) — the current rule + neural hybrid
