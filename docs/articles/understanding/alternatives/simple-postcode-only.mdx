...
- [What is a postcode?](../the-problem/what-is-a-postcode.md) — postcodes as routing instructions
- [What is a ZIP Code and how is it structured?](../the-problem/what-is-a-zip-code.md) — the US system in detail
- [Falsehoods about postcodes](../why-its-hard/falsehoods-postcodes.md) — the assumptions that break postcode-based geocoders
