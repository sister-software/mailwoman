...
- [How humans break addresses](../why-its-hard/how-humans-break-addresses.md) — the failure modes the human corrects
- [How it will work](../our-approach/how-it-will-work.md) — Phase 5 Studio, the human-correction feedback loop
