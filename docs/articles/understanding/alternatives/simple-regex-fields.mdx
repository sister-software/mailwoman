...
- [The tokenization tautology](../why-its-hard/the-tokenization-tautology.md) — why positional regexes fail on non-Anglophone addresses
- [How it used to work](../our-approach/how-it-used-to-work.md) — Mailwoman v1's rule-based approach, which is essentially this with more rules
