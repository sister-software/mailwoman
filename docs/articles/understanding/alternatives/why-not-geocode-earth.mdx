...
- [From Pelias to Mailwoman](../our-approach/from-pelias-to-mailwoman.md) — the fork history
- [The tokenization tautology](../why-its-hard/the-tokenization-tautology.md) — the Pelias parser's structural ceiling
- [How it used to work](../our-approach/how-it-used-to-work.md) — Mailwoman v1 (pre-fork Pelias) in detail
