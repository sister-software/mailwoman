...
- [What is a postcode?](./what-is-a-postcode.md) — postcodes as routing instructions, not polygons
- [What is a ZIP Code and how is it structured?](./what-is-a-zip-code.md) — why ZIP codes don't have boundaries
- [How can a building have two addresses?](./how-can-a-building-have-two-addresses.md) — the vertical dimension of addressing
