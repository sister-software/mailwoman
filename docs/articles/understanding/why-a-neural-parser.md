...
- [How mail delivery works](./how-mail-delivery-works.md): the postal system is already fuzzy. It tolerates ambiguity.
- [How humans break addresses](./how-humans-break-addresses.md): real input is messier than any database expects.
- [The database fallacy](./the-database-fallacy.md): there is no master list of correct addresses.
- [The tokenization tautology](./the-tokenization-tautology.md): traditional parsers hit a structural ceiling.
- [The 90% trap](./the-90-percent-trap.md): the tail of failures is the expensive part.
