...
- [The 90% trap](./the-90-percent-trap.md) — the economic argument for owning your parser
- [The database fallacy](./the-database-fallacy.md) — why even Google's database has gaps
