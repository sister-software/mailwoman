...
- [How humans break addresses](./how-humans-break-addresses.md) — the failure taxonomy the parser must handle
- [The database fallacy](./the-database-fallacy.md) — why there is no master list of all addresses
- [The 90% trap](./the-90-percent-trap.md) — why the 90% that works isn't enough
