...
This is the deepest layer of the postal system's fuzziness: the human at the end of the chain who overrides the machine's decisions. It is how the system works every single day.
