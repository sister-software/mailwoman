...
[postcode-only diagnostic](../evals/2026-05-29-postcode-diagnostic.mdx)
run on v0.6.0.
...
- **CRF disablement did not cause v0.6.x failures.** v0.6.x was
  ...
  [fp32-CRF fix](../evals/2026-05-28-fp32-crf-diagnostic.mdx) is
...
- [Postcode-only diagnostic (v0.6.0)](../evals/2026-05-29-postcode-diagnostic.mdx)
- [v0.6.2 step 100K eval](../evals/2026-05-29-v0.6.2-100k-eval.mdx)
- [v0.6.3 step 100K eval](../evals/2026-05-29-v0.6.3-100k-eval.mdx)
