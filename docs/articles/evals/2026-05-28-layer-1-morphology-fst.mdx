...
Applied the newly-landed [street-morphology FST](../concepts/street-supplement-architecture.mdx)
...
[WOF hierarchy gap](../concepts/wof-hierarchy-gap.mdx) doc: the admin FST has no street
...
the [v0.6.1 calibration probe design](2026-05-28-night-2-postmortem.mdx): when the hallucinations
...
Per [DeepSeek's turn 2 recipe](2026-05-28-night-2-postmortem.mdx#deepseeks-three-rubrics-for-a-night-shift-skill)
and the [street-supplement architecture doc](../concepts/street-supplement-architecture.mdx):
...
- [Street-supplement architecture](../concepts/street-supplement-architecture.mdx) — the design
  this eval validates against
- [WOF hierarchy gap](../concepts/wof-hierarchy-gap.mdx) — the structural cause
- [v0.6.1 error analysis](v0.6.1-error-analysis.mdx) — the original regression
- [2026-05-28 night-2 postmortem](2026-05-28-night-2-postmortem.mdx) — the postmortem that drove
  the design consult
