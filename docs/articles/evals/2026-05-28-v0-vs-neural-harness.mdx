...
Per [DeepSeek consult turn 6](2026-05-28-night-2-postmortem.mdx): without this harness,
...
- [Layer 1 morphology FST eval](2026-05-28-layer-1-morphology-fst.mdx) — preceding eval that
...
- [2026-05-28 night-2 postmortem](2026-05-28-night-2-postmortem.mdx) — postmortem that triggered
  this assessment
