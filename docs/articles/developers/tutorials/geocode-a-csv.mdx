...
**The classifier, the lookup, the resolver and the `ShardProvider` are built once, outside the loop.**
...
report. The `ShardProvider` was asked for DC and had nothing to give.
