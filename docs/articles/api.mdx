...
| `mailwoman serve` (native `/v1/*` surface)                                   | `/v1/parse`, `/v1/geocode`, `/v1/batch`, `/v1/resolve`, `/v1/format` | [mailwoman.json](pathname:///openapi/mailwoman.json) |
...
| -------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Python   | [`mailwoman-client`](https://pypi.org/project/mailwoman-client/) (PyPI)     | [`openapi-python-client`](https://github.com/openapi-generators/openapi-python-client) |
| Rust     | [`mailwoman-client`](https://crates.io/crates/mailwoman-client) (crates.io) | [`progenitor`](https://github.com/oxidecomputer/progenitor)                            |
