...
and saves you from having to conform to our [open-source requirements and restrictions](./open-source.md).
...
Rates, tiers, and the size fence are published on the [pricing page](./pricing.mdx).
