...
- [`docs/articles/plan/reference/VERDICT_SMOKES.md`](../../articles/plan/reference/VERDICT_SMOKES.mdx) — the verdict-smoke discipline doc (pending update with the eff_batch lesson + ratio-probe lesson)
