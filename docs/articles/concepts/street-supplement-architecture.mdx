...
[Layer 1 eval (2026-05-28)](../evals/2026-05-28-layer-1-morphology-fst.mdx).
...
- [v0.6.1 error analysis](../evals/v0.6.1-error-analysis.mdx) — empirical regression that surfaced the gap
- [2026-05-28 night-shift postmortem](../evals/2026-05-28-night-2-postmortem.mdx) — postmortem that triggered this design consult
