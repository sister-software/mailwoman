...
- [The staged pipeline](../understanding/our-approach/the-staged-pipeline.md) — the narrative for _why_ the stages exist
...
- [The staged pipeline](../understanding/our-approach/the-staged-pipeline.md) — why these stages exist
