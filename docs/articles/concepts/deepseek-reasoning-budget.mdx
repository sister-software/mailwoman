...
- [Synthetic corpus — alignment validation is load-bearing](./synthetic-corpus-validation.mdx) — why the validator caught this even when the worker silently accepted truncated responses
- [`CORPUS_V0_4_0_GENERATION.md`](../plan/reference/CORPUS_V0_4_0_GENERATION.mdx) — the operational record, including B2's actual prompt-engineering decisions and rate parameters
