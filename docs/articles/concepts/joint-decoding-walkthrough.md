...
[The knowledge ladder](../understanding/our-approach/the-knowledge-ladder.md) explains _why_ the v0.5.0 pipeline grew two new information layers (Stage 2.7 phrase grouper, expanded Stage 5 reconcile). This article walks through _what they actually do_ on one concrete input, end-to-end.
...
If you have not read [The staged pipeline](../understanding/our-approach/the-staged-pipeline.md), do that first — this article assumes you know the six stages by name.
...
- [The knowledge ladder](../understanding/our-approach/the-knowledge-ladder.md) — the conceptual frame for why these layers exist
- [The staged pipeline](../understanding/our-approach/the-staged-pipeline.md) — the six-stage runtime composition
