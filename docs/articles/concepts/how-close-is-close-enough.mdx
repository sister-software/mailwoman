...
Mailwoman resolves to the finest tier it has data for, and labels which one it used (measured on 1172 real TX facility addresses, [`2026-06-17-geocoder-vs-provided-coords`](../evals/resolver-geo/2026-06-17-geocoder-vs-provided-coords.md)):
