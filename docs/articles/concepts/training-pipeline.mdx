...
The eval report is committed to git as part of the ship PR — see [the latest Tier 2 ship's eval report](../evals/stage2-step-001800-eval.mdx) for the v3.0.0 numbers (filename preserves the historical "stage2" naming).
