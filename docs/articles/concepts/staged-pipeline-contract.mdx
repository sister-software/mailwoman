...
- [STAGES.md (reference)](../plan/reference/STAGES.mdx) — the full per-stage contract with type definitions, error semantics, and edge cases
...
- [STAGES.md](../plan/reference/STAGES.mdx) — the full per-stage type contract
- [The staged pipeline](../understanding/our-approach/the-staged-pipeline.mdx) — why these stages exist
- [QUERY_SHAPE.md](../plan/reference/QUERY_SHAPE.mdx) — the structural-prior sub-system feeding stages 2 and 2.5
