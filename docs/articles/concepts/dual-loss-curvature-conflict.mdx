...
If you haven't read [the v0.4.0 ablation retrospective](../retrospectives/v0-4-0-ablation-campaign.mdx) and the [bisect-by-elimination blog post](pathname:///blog/2026-05-24-bisect-by-elimination), do those first — they set up the failure pattern this article diagnoses.
