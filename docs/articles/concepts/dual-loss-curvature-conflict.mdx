...
- [Synthesis review](../reviews/2026-05-24-claude-deepseek-followup-synthesis.mdx) — the multi-agent conversation that produced both the dual-loss hypothesis and its falsification
- [`VERDICT_SMOKES.md`](../plan/reference/VERDICT_SMOKES.mdx) — the smoke discipline that catches this class of divergence (constant-LR, full-eff-batch)
