...
If you haven't read [the v0.4.0 ablation retrospective](../retrospectives/v0-4-0-ablation-campaign.mdx) and the [bisect-by-elimination blog post](pathname:///research/2026-05-24-bisect-by-elimination), do those first — they set up the failure pattern this article diagnoses.
...
- [v0.4.0 ablation campaign retrospective](../retrospectives/v0-4-0-ablation-campaign.mdx) — first appearance of the divergence fingerprint, before the diagnostic was named
