...
`scripts/eval/honest-eval.sh` + `scripts/eval/pip-containment.py` implement this; see [the honest-eval report](../evals/2026-06-08-honest-eval.mdx) for the full run.
