...
- **Want the exact tag union the model emits?** [The component schema reference](https://github.com/sister-software/mailwoman/blob/main/docs/engineering/reference/SCHEMA.mdx) is the single source of truth.
