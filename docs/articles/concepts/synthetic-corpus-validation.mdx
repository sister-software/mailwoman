...
- [The knowledge ladder](../understanding/our-approach/the-knowledge-ladder.md) — why we keep generation honest at this layer rather than trying to fix it downstream
