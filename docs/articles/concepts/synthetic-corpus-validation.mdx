...
- [`CORPUS_V0_4_0_GENERATION.md`](../plan/reference/CORPUS_V0_4_0_GENERATION.mdx) — the operational record for the v0.5.0 corpus generation, including the actual prompts used
