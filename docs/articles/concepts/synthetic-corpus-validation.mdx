...
- [The knowledge ladder](../understanding/our-approach/the-knowledge-ladder.mdx) — why we keep generation honest at this layer rather than trying to fix it downstream
