...
**Terminology note (2026-05-22):** This document uses **"Tier"** for label-vocabulary expansion (Tier 1 = coarse, Tier 2 = +fine, Tier 3 = +POI). Historically called "Stage 1/2/3" — renamed to free the word "Stage" for runtime-pipeline stages (see [`concepts/the-staged-pipeline`](../../understanding/our-approach/the-staged-pipeline.md)). Shipped artifacts (model cards, eval filenames like `stage2-step-001800-eval.md`, npm v3.0.0 releases) preserve the old "Stage" naming as historical record.
