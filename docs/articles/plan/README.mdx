...
3. Continue. Do not block waiting for input from outside the lab unless the decision is irreversible (npm package name, public API contract, data license commitment).
