...
The v0.8.0 German order-shard experiment ([postmortem](../evals/2026-06-02-night-4-postmortem.mdx))
...
- [German order-shard postmortem](../evals/2026-06-02-night-4-postmortem.mdx) — the failure that motivated
  this.
