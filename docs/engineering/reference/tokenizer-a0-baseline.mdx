...
The v0.5.0 plan ([`PHASE_8 §A`](../phases/PHASE_8_v0_5_0_fresh_slate.mdx)) splits the tokenizer retrain into two steps:
...
- [PHASE_8 §A](../phases/PHASE_8_v0_5_0_fresh_slate.mdx#a-tokenizer-retrain--multi-script--adversarial-coverage) — the plan's tokenizer scope
- [Tokenization](../../concepts/tokenization.mdx) — what SentencePiece does and why byte-fallback matters
- [v0.5.0 — as shipped](../v0-5-0-shipped.mdx) — where A0 fits in the six-thread bundle
