...
| "Training described entirely by a config file, code is the runner" hygiene                                           | spacy.cfg pattern                                                                                                                                     | `corpus-python/train.py` config shape — adopt the pattern without taking spaCy as a dep |
