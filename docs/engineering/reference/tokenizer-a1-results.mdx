...
| cyrillic    | 2.2%      | 2.4%      | +0.2 pt      | 0.0%           | +2.4 pt     | within noise of A0. Eval fixture's Cyrillic slice is short / common-vocabulary; not enough surface for the B2 cyrl shard to change the number.                                                          |
