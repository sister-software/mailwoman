...
- **A1 beats v0.1.0 leakage on cjk** — the largest non-Latin script class and the most important target. v0.1.0's CJK win was always a WOF admin-name artefact (see [tokenizer-a0-baseline.md](./tokenizer-a0-baseline.mdx#why-a0-looks-worse--the-wof-admin-name-leakage-hypothesis)); A1's CJK win holds.
