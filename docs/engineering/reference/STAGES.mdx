...
- **Canonical:** this file is the canonical interface contract for the runtime pipeline. Any stage implementation must conform.
...
- [`concepts/the-staged-pipeline`](../../records/site-2026-08/understanding/our-approach/the-staged-pipeline.mdx) is the **public-facing narrative** version. This file is the implementer's contract.
