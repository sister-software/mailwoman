...
Population is an administrative headcount. [Wikipedia importance captures cultural prominence](../../records/site-2026-08/concepts/importance-vs-population.mdx) — the place's reference, link, and discussion frequency across languages.
...
The TSV is cached beneath `$MAILWOMAN_CACHE_ROOT` after first download. Pass `--tsv` to skip the download.
