...
- [Dual-loss curvature conflict](../../concepts/dual-loss-curvature-conflict.mdx) — why crf_loss_weight=0 works
- [v0.5.0 — as shipped](../v0-5-0-shipped.mdx) — the thread table
- [What the eval numbers mean](../../understanding/our-approach/what-the-eval-numbers-mean.mdx) — plain-English interpretation
