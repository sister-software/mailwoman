...
Captures the design intent for the `QueryShape` sub-system, a stage 2 + 2.5 addition to the runtime pipeline ([the-staged-pipeline](../../records/site-2026-08/understanding/our-approach/the-staged-pipeline.mdx)). Bitter-lesson-safe because it recognizes _what shape an input has_, not _which strings are localities_.
