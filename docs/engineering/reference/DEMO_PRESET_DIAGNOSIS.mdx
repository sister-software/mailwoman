...
- [`TRAINING_RECIPE_CHANGES.md`](./TRAINING_RECIPE_CHANGES.mdx) — training knobs including source_weights
- [`../../concepts/dual-loss-curvature-conflict.md`](../../concepts/dual-loss-curvature-conflict.mdx) — why CE-only training
