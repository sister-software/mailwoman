...
2. **Curated exonym table**: a provenance-tracked exonym→canonical dataset consulted at rank time.
   ...
   of no-irrelevant-trivia if hand-grown.
3. **Official-language names are names** _(recommended)_: widen the name-exact sub-tier's
   ...
   alias-exact (its "Paris" is a truncation rather than an official name in another language);
...
- Check: the bare-namesake gauntlet rows (Paris/Dublin/Melbourne/Vancouver/Åbo + ME/NY abbrevs) +
