...
> **Public home (Phase 4, 2026-07-14):** this policy now lives in [`docs/articles/contributing-docs.mdx`](../../records/site-2026-08/contributing-docs.mdx) ("Retiring a page"); this file is the signed original, kept for provenance.
...
5. **Demotion (public → excluded) is for mistakes rather than age.** A page leaves the public site only if it should never have been public. Age alone is an Archive matter, never a deletion or exclusion matter (plan non-goal).
