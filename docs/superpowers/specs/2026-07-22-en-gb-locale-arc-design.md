...
| Sequencing   | Independent of BR (v3.8.6) and PT/RO (v3.9.1) queues     | Neither has run; nothing competes for Modal. Whether 8ks merge into one ship is decided after probe reads rather than now.                                                                                                                                                                                                                                                                      |
...
- Pass → 8k → full absolute-floor check battery + gauntlet (the v7.1.0 lesson: full check at ship, notgolden-2pp).
