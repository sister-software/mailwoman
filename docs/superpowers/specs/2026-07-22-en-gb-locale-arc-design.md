...
| Sequencing   | Independent of BR (v3.8.6) and PT/RO (v3.9.1) queues     | Neither has run, so no job competes for Modal. Whether the 8k runs merge into one ship is decided after the probe reads.                                                                                                                                                                                                                                                                                                               |
