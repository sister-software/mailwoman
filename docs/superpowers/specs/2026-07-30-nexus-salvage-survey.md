...
- **Fabric ingestion**: `sync/fcc/fabric/data-source.ts` is a commented-out TypeORM stub rather than a head start — and Fabric ingestion is forbidden anyway (2a spec §2.2).
