...
3. **PR C — the sweep**: postcode/polygons/supplemental builders → subcommands, mutator folds (#1026's fix lands here via the augment folds), diagnostics triage, remaining deletions.
