...
Status: steps 1–6 and the release wiring of step 7 landed on `main` 2026-09-06; the base is the Korean run over the kana recipe (#2184; the kana-register run #2165 before it) (epic #2164; record
