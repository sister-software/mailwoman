 ...
 *   filename" remedy, not an escape from it. promotion-gate.ts refuses a candidate carrying a known regression and
 *   prints the ledger command on a pass. @mailwoman/locale-gate derives the hint the pipeline reads. v1-parse-gate,
 *   boundary-stress-gate and fr-admin-split-gate each grade a different board. mwdev_gate answers from the warm engine.
