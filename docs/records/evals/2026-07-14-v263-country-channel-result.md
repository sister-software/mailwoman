...
| **NON-INF — held-out US coordinate** (300 FDIC, ≤5km) | 279                    | 278 (z −0.16)                | ✓ PASS — not by a measured margin worse                             |
...
This is the mirror image of the preceding finding. On the leading-long-form WOF-admin distribution (golden, the
