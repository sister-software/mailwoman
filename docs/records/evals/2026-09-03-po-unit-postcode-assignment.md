...
| Object coordinates | `$MAILWOMAN_DATA_ROOT/db/uprn/uprn.db` (OS Open UPRN, release 2026-08)                                           | 531,266 joined by UPRN (35 missing) | manifest `os-open-uprn`, OGL-UK-3.0                                                                       |
| Centroids          | `$MAILWOMAN_DATA_ROOT/db/wof/postalcode-gb-codepoint.db` (Code-Point Open), PO box + 0.05°                       | 43,069 (24,496 `PO`)                | OGL-UK-3.0                                                                                                |
