...
- **Distributional / open-vocab tags** (street*prefix, street_suffix, unit, locality) — the model has to \_learn the boundary* from context. Synth shard + retrain is the right tool; these are where negative-space training compounds.
