...
- **The flip is now justified by the check, notthe accuracy.** The original bar wanted ≤0.5% per-field regression with non-negative accuracy. Every locale clears it: DE 0.2%, US 0.0%, FR 0.0%, NL 0.3%, IT 0.0%, ES 0.3% — and joint beats argmax everywhere, by +25pp on the German collision and +15pp on IT/ES. FR's old 2.0% churn, which Phase I treated as a noise floor, turned out to be the digit-less-postcode and accented-capital bugs; it's gone.
