...
- **The generalized builder (S3) hit real walls** I should have anticipated: FR's OA CSV is 2.5 GB (over
  ...
  is proven; the rest is held, directly documented, not half-shipped.
...
- **S1 — the anchor is essential in both orders, not a US-order band-aid.** v0.9.1 anchor-on model, DE
