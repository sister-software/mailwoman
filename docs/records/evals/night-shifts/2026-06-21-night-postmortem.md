...
All the big changes are built + measured on a copy; the _apply_ (one `build-unified-wof` + candidate rebuild + R2 republish) is the only gated part — and it activates ALL of them at once.
