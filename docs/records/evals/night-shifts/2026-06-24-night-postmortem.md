...
The planned Nominatim head-to-head was **withheld**: the messy-input fetch hit rate-limiting (AU 100% null, FR 45%, PT 38%) and is unreliable. the result from 06-23 (#775, US 99 vs 84).
