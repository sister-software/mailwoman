...
not just unit-tested — the conditional re-measure happened this shift:
...
- The DE re-measure was NOT actually symlink-conditional (#397) — it runs against the explicit v0.9.4 model in
