...
| `operatingStates`            | yes                    | **0 of 12** — never set | workbook-only registered footprint; staged as an attribute, no edge reads it                                                                                                                  |
