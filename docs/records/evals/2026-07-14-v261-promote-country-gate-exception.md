# 2026-07-14 — v261 promoted (6.1.0); the country 2pp check, documented as a cosmetic exception

v261 (`v2.6.1-span-boundary-full`, #727 stage-1) is promoted to the shipped `neural-weights-en-us`
default. It is a clean improvement over v241 on the schema-correct checks, and it trips the golden
country 2pp pre-publish check — which this note documents as a **cosmetic exception** with the
falsifier evidence that justifies shipping through it. No check was silently relaxed.

## Why v261

| check                                | v241 (shipped) | v261      | note                                       |
| ------------------------------------ | -------------- | --------- | ------------------------------------------ |
| parity street (triaged)              | 0.3967         | 0.5281    | +13pp — the schema-correct campaign check  |
...
The −6.6pp golden country recall fired the 2pp pre-publish check. A falsifier (DeepSeek session
