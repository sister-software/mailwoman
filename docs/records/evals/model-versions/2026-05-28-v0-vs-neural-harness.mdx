---
sidebar_position: 36
title: "2026-05-28 v0-vs-Neural harness — direct assessment"
---
...
| functional.test.ts      | 34       | 3%       | Cross-reducing cases                                 |
...
This is a tokenizer/encoder issue rather than a schema issue. The model can't recover when SentencePiece pieces don't reassemble to the original characters.
...
This is the "direct assessment" the postmortem called for. The implications:

1. **Locale coverage is the dominant gap.** US, FR, and a portion of AUS are in distribution;
...
3. **Intersections need targeted corpus work.** v0.6.0's synth-street extract taught street
...
[`falsehoods-streets.md`](../../site-2026-08/understanding/why-its-hard/falsehoods/falsehoods-streets.mdx) as 22 explicit
...
2. `R 5, 6-13, D-68161 Mannheim` — grid address with no street. v0's classifiers force a
   street-shaped reading that doesn't fit; neural correctly produceslocality + postcode.
...
- [Street-supplement architecture](../../site-2026-08/concepts/street-supplement-architecture.mdx) — the design context
...
- [Falsehoods about street names](../../site-2026-08/understanding/why-its-hard/falsehoods/falsehoods-streets.mdx) — the
