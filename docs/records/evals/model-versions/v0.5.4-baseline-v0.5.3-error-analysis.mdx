...
~80% of failures are SCHEMA MISMATCH rather than model error. The model is doing Stage 2 (10 tags) while the golden set uses Stage 3 (~16 tags). Boundary errors will largely disappear when Stage 3 ships and street is decomposed.
