...
- **PR #559** — config (`v1.4.0-charoffset.yaml`), bridge-retirement check (`v0.5.0-bridge.json`),
...
2. **Bridge-retirement check thresholds.** `over-merge precision` + `#518 punctuation lens` need
