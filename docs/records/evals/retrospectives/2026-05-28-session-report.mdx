...
Reference: [Technical doc](/docs/concepts/onnxruntime-web-webgpu-failure mode). Research blog post: "Our model worked in CI but broke on every real device".

## Infrastructure migration

### GitHub Pages + HF Bucket

Replaced the lab nginx + rsync deployment with:
