...
- **PR #772 + the `/mailwoman-release` skill** — the CI-publish runbook, codified from this reduce and its five landmines.
...
- **v1.9.2** — once SE lands, it's the 17th locale in the same 3-order extract; GB/IE/HU remain genuinely conditional (commercial / no open feed).
