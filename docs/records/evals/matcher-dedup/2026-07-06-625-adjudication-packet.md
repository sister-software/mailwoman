...
**[distinct]** in fact different co-located providers (model over-merge). Mark inline and return.
...
## Cluster 9 — 6 records, 2 org-name entities → verdict: **[distinct]** — Two different surgery centers at two different addresses (3534 Vista Rd vs 5146 Preston Ave, different officials) fused via a shared historical name row. actual over-merge.
...
**14/21 clusters are [same] (yardstick error) · 7/21 are [distinct] (actual over-merge).**
