...
- **Non-Latin adversarial set (new eval split)**: country F1 ≥ 0.50 (vs current ~0 — these are mostly byte-fallback empty preds). This is the tokenizer win directly measured.
