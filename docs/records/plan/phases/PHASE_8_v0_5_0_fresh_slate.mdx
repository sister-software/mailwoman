...
- [The knowledge ladder](../../understanding/our-approach/the-knowledge-ladder.mdx) — conceptual framing for what the missing rungs do
- [The pipeline contract](../../concepts/staged-pipeline-contract.mdx) — runtime mechanics
