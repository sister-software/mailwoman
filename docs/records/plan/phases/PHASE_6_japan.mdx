...
- **Excellent open data.** MLIT (国土交通省) publishes complete address data freely. Quality comparable to BAN.
...
- Adapter for MLIT address data (CSV format, complete coverage of JP)
...
If core code did need to change, the change is the deliverable rather than the JP support. Document what changed and why so future locales (Korean, Thai, etc.) benefit.
