...
[exotic-POI understanding docs](../understanding/exotic-poi/landmark-queries.mdx) already describe as a
...
- [Exotic-POI understanding docs](../understanding/exotic-poi/landmark-queries.mdx) — the landmark /
