...
1. [The knowledge ladder](../understanding/our-approach/the-knowledge-ladder.mdx) — the conceptual framing for why the two new layers (Stage 2.7 phrase grouper, expanded Stage 5 reconcile) exist.
2. [The staged pipeline](../understanding/our-approach/the-staged-pipeline.mdx) — the runtime composition end-to-end.
