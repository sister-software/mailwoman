...
The second question is "can I use it today?" The docs should answer that plainly too: "yes, with these caveats, and here's what's coming." The status page is the vehicle for that answer.
