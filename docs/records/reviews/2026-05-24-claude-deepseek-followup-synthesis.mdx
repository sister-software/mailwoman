...
The full technical write-up of the diagnostic, the cooperative-vs-conflict regime model, and the repair is at [`docs/articles/concepts/dual-loss-curvature-conflict.md`](../concepts/dual-loss-curvature-conflict.mdx).
...
- [`docs/articles/plan/v0-5-0-shipped.md`](../../articles/plan/v0-5-0-shipped.mdx) — as-shipped state of v0.5.0
