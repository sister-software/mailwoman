...
**Mitigation:** if golden regression lands in the 0.5–1.5pt band, manually inspect all disagreement entries before deciding. If >half are debatable or the result shows wrong in golden, expand the check tolerance. If they are actual (concordance damage), the matrix stands.
