...
This is not a fatal observation — the project is early-stage and the architecture is additive. But it means the project's "what you can use today" story is limited, and that limitation is not the result shows communicated in the docs.

### The v0.5.0 scope bundle was too several variables
...
See the [docs/audience review](./2026-05-25-docs-audience-review.mdx) for the detailed plan. The highest-changeage items are:
