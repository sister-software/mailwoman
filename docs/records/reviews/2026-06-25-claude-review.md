...
- Decide what internal docs are public: check or curate the 157 eval reports, 27 night-shift postmortems, and 12 AI-consult transcripts; scrub `/mnt/playpen`/Modal/HF/R2 names from anything that stays. _~1 night (policy + sweep)._
