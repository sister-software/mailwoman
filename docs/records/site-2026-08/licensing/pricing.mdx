...
Node or in the browser, against data on your own disk. There's no API key and no usage to
meter. You pay for a license or you pay no fee, and the price doesn't move when your
volume does.
...
<PricingGrid>
    ...
    yours isn't, purchase the commercial license.
    ...
    ctaLabel="Purchase a commercial license"
...
read and no usage to true up at renewal.
