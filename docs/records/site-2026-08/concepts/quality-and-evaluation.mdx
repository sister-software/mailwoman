...
**Checks are pre-registered.** The target numbers and no-regression bounds for a change are written into the training config before the first optimizer step runs; the runbook's phrasing is "If you can't define the check, you aren't ready to train." Written down first, a check can't quietly bend around the result it was meant to judge.
