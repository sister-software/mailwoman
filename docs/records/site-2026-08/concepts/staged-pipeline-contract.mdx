...
- **Conventions mask** (`addressSystemConventions: "auto" | SystemCode`, v4.3.0+): the model's
  ...
  repair. Threshold-gated (0.8) — never fires on a guess; undetected systems parse unmasked.
...
Running a v4.4.0+ model WITHOUT these settings reproduces measured gate failures (po_box 60.4 vs
