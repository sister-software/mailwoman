...
- [STAGES.md (reference)](https://github.com/sister-software/mailwoman/blob/main/docs/engineering/reference/STAGES.mdx) — the full per-stage contract with type definitions, error semantics, and edge cases
...
stages — they run inside `classifier.parse` and are part of the SHIP CONFIG contract (the model
...
enhancements for those weights, they are the decode contract.
...
- [STAGES.md](https://github.com/sister-software/mailwoman/blob/main/docs/engineering/reference/STAGES.mdx) — the full per-stage type contract
