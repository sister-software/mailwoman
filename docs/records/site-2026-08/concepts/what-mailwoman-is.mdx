...
- **Calibrated.** The confidences are isotonic-calibrated against held-out
  data, so "0.6" means right-about-60%-of-the-time, not "my rule was moderately
...
matched, not how likely the reading is to be correct. A sieve cannot say "I'm not sure." Novel
