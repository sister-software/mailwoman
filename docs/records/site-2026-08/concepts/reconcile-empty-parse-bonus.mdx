...
This is the same shape of bug — a natural-reading parameter (`kSpan = 3`) that silently breaks the contract — and the same fix (anchor by structure rather than by ranking).
