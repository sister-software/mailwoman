...
The tier table lives in [the scope declaration](https://github.com/sister-software/mailwoman/blob/main/docs/engineering/SCOPE.mdx), and it is a statement about evidence, not a switch in the code: a locale is claimed only when a coordinate-graded eval exists for it. Summarized, with what membership means when you run the thing:
