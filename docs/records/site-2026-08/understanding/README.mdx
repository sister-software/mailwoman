...
19. **[Shapes and dimensions](./why-its-hard/falsehoods/falsehoods-shapes.mdx)** — not a point rather than a polygon rather than a building rather than at ground level rather than unique per coordinate.
20. **[Precision and frontages](./why-its-hard/falsehoods/falsehoods-proximity.mdx)** — not one correct coordinate rather than always "close enough," not necessarily the front door.
...
29. **[Why notuse Google's API?](./alternatives/why-not-google-api.mdx)** — pricing, terms, lock-in, and when renting is the right choice.
...
44. **[Landmark queries](./exotic-poi/landmark-queries.mdx)** — Eiffel Tower, Golden Check Bridge, Empire State Building.
...
The team behind Mailwoman speaks several languages, and English is a second language for several readers. Our goal in these docs is **plain English with technical terms defined on first use**. If a sentence is hard to follow, that is a documentation bug — please open an issue.
