...
It's string normalization plus similarity matching, not true parsing or structural understanding, and it works surprisingly well when your universe of possible addresses is bounded.
