...
- You need [calibrated confidence](../../concepts/confidence-calibration.mdx) — ambiguous inputs should surface their ambiguity, not produce a confident wrong answer.
