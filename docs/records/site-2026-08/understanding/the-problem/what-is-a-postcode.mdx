...
A postcode is built to move mail, not to locate things. The geocoder's job is to treat it as a spatial hint for the resolver, not as a spatial fact on its own.
...
- [How mail delivery actually works](./how-mail-delivery-works.mdx) — the system postcodes were designed for
