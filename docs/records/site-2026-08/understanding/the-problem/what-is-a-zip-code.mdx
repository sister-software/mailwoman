...
The US ZIP Code is the most influential postcode system in the world — not because it is the best, but because US-origin address data dominates geocoding training sets and shapes what parsers expect. Understanding its structure is essential for understanding why US-trained parsers fail on international addresses.
...
| --------------- | ---------------------------------------------- | --------------------- | ----------------------------------------------------------------------- |
| **Standard**    | Street addresses                               | 90210 (Beverly Hills) | Resolves to a post office delivery area — approximate rather than exact |
| **PO Box only** | Serves only PO boxes at a specific post office | 10001 (part of NYC)   | Centroid at the post office rather than at residents' locations         |
