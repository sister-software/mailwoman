...
Mailwoman [evaluates itself](../../concepts/quality-and-evaluation.mdx) by running against a set of 4,535 hand-labelled addresses (the "golden set") and measuring how well each pipeline mode does. This article explains the four modes, the metrics, and what the v0.5.0 results mean — in plain terms.
