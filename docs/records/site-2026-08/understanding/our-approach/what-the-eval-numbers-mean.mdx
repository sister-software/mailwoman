...
**Empty-parse rate** — how frequently does the parser give up entirely and return nothing? Lower is better. A parser that always guesses something (even if wrong) scores 0% here.
