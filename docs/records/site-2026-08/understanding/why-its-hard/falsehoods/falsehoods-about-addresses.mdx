...
This article series is inspired by and cites Michael Tandy's [original catalogue of address falsehoods](https://www.mjt.me.uk/posts/falsehoods-programmers-believe-about-addresses/), maintained since 2013. Tandy's article is a taxonomy of assumptions that break parsers, validators, and databases. This series expands on that taxonomy, adding historical context on how geocoders have handled (or failed to handle) each category, and what Mailwoman's neural approach changes.
...
| Streets   | [Falsehoods about street names](./falsehoods-streets.mdx)                       | Missing suffixes, numbered streets, recurring names, addresses with no streets at all                                  |
...
| Hierarchy | [Falsehoods about administrative hierarchy](./falsehoods-hierarchy.mdx)         | No states, no counties, duplicate city names, city-states                                                              |
...
| Shapes    | [Falsehoods about address shapes and dimensions](./falsehoods-shapes.mdx)       | Not a point rather than a polygon rather than a building rather than at ground level rather than unique per coordinate |
| Precision | [Falsehoods about geocoded precision and frontages](./falsehoods-proximity.mdx) | Not one correct coordinate rather than always "close enough," not the front door                                       |
