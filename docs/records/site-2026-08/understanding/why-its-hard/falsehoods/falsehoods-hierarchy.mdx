...
`Brooklyn, NY` is a borough of New York City, not a municipality. USPS accepts it as a "preferred last line" city for several NYC ZIP codes. The legal municipality is New York. The postal city is Brooklyn. Both are correct in different contexts.
