...
That's a more fixable problem than being wrong. So we went looking for what made it go quiet — and found two different things, one cchange and one just embarrassing.
