...
**[Mailwoman](https://mailwoman.sister.software)** is an open-source address parser. This post is a training log entry from May 2026 documenting the v0.5.0 divergence investigation. For current project status, see [what ships today](/docs/developers/status).
