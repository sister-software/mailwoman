...
- [`docs/articles/plan/reference/TRAINING_ENV.md`](https://github.com/sister-software/mailwoman/blob/main/docs/engineering/reference/TRAINING_ENV.mdx) — playpen container ROCm bootstrap
