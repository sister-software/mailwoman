...
So: a year in, did the neural net actually beat the rules parser? The answer is _mostly a tie, until the address gets weird_ — and the weird is where it gets interesting.
