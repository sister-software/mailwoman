...
That's the pitch, and it's worth being honest about why it's unusual, because the three things the rest of the market hands you each ask you to give something up.
...
Or run a parser by itself. libpostal is the open address parser everyone embeds, and it's genuinely good. It's also a 1.8 GB trained model (2.2 GB for the Senzing variant), written in C with no supported path to the browser, and it stops at parsing. It tells you which token is the street; it doesn't tell you where the street is.
