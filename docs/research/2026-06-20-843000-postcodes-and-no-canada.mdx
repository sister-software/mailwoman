...
There's one test in the stack that doesn't care what I built. It loads the actual demo in a real browser, types an address into the box, and reads the coordinate off the map — the pin the user would see. The whole point of it is to grade the _assembled_ answer, not any single piece of the implementation. Before promoting the new gazetteer I added a Canadian case to it: `100 Queen Street West, Toronto, ON M5H 2N2`, and assert the pin lands somewhere in Toronto.
