...
It's a change, not a wand. Crank the threshold and you hand more rows to humans; that's the cost, stated directly, and it's yours to set against your own tolerance for a wrong match. What we've done is make the trade legible and put an direct number on both sides of it.
