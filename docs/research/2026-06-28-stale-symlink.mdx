...
tags: [geocoding, evals, retrospective, hubris]
---
...
Start with the symptom. Ask mailwoman's drop-in API for `Tirana, Albania` and you got no result. Same for Yerevan, Kabul, Ulaanbaatar, Sarajevo — 147 countries where the candidate gazetteer, the table the demo and the drop-ins query, held exactly zero rows. You didn't get a wrong coordinate, you got silence, as if the country didn't exist.
...
That's the result, and we staged it to ship. It's the part you'd put in the changelog. I learned more from what came next.
