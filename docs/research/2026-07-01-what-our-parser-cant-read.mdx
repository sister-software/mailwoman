...
tags: [decoder, corpus, methodology, multilocale, lossless, advanced]
---
...
So you ship that parser. It looks great on the addresses you tested it against. And you have no real idea what it's dropping in production, because the output format was built to hide exactly that.
...
That's a small change to a decoder. It turns into a diagnostic you can point at real data.
