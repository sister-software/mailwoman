...
**[Mailwoman](https://mailwoman.sister.software)** is an open-source address parser. This post is a historical retrospective on the v0.4.0 training campaign (May 2026). For current project status, see [what ships today](/docs/developers/status).
