...
/**
 * Surfacing why the WOF cascade returned no hit — saves the operator from guessing whether the problem is the parser
 * (didn't extract a locality / postcode), the WOF slim subset (entry not indexed), or a known data quirk (postcode in
