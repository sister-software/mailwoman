 ...
 * that should show the band. The single-category licensing sidebar is excluded, so
 * its pages keep the stock layout (no band, no offsets).
 */
 ...
 * from the *target* sidebar's entry link — so cross-section links work even though
 * only the active sidebar's items are in context. One hook per instance keeps the
 * rules-of-hooks contract clean across the fixed `DOCS_SECTIONS` list.
 */
