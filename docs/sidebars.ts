...
const sidebars: SidebarsConfig = {
	...
	// deciding whether Mailwoman fits rather than building against it. Overview defines the thing.
	...
	developers: [
		...
		},
		{
			...
			// different question (an existing client rather than a new one), and the browser page needs no
		...
		},
		{
			type: "category",
			label: "Reference",
			// Look-up order rather than reading order: a reader arrives here knowing the fact they want,
			...
			// docs/scripts/generate-cli-reference.ts on every build — edit the command specs rather than
			// the page.
			items: [
