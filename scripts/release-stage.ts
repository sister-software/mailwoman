...
export const SANCTIONED_RELEASE_ABSENCES: Readonly<Record<string, string>> = {
	...
	"packages/locale-hint":
		"renamed npm name — awaiting the bless-package first publish, which npm Trusted Publishing cannot do from CI " +
		"(RELEASING.md, “Adding a NEW package”). Joining the list before that fails the whole release at this " +
		"workspace with a bare E404. The retired name is deprecated on npm once this one is blessed.",
}
