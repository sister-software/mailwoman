 ...
 *
 *   Run: node --experimental-strip-types scripts/record-matcher/geocoder-vs-provided-coords.ts\
...
async function main(): Promise<void> {
	...
	lines.push("")
	lines.push(
		`_Generated by \`scripts/record-matcher/geocoder-vs-provided-coords.ts\`. Source: TX HHSC ` +
