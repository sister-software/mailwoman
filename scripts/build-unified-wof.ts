...
// ingestGeonamesAliases moved to @mailwoman/resolver-wof-sqlite/geonames-aliases — ONE shared
// implementation across this canonical `--geonames-countries` build, the standalone
// `build-admin-geonames-fold`, and the `mailwoman gazetteer` commands. Imported at the top.
