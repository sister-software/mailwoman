 ...
 */
export const LegalStatisticalAreaDescription = {
	/**
...
export type LegalStatisticalAreaDescription =
	(typeof LegalStatisticalAreaDescription)[keyof typeof LegalStatisticalAreaDescription]
