...
# on, it -inf'd the boundary slice's gold FR street_prefix ("Rue" → street_prefix) and exploded
# train_loss to ~7M (killed at step 2000). Verified against the v0.5.0 FR/ban slices, 2026-06-18.
