...
const GRAINS: Grain[] = [
	...
	{ key: "org-name", label: "org-name", classes: 956, note: "same-org collapse by\naddress STRING key" },
	{
		key: "org-name-coord",
		label: "org-name (coord)",
		classes: 928,
		note: "collapse by geocoded\nBUILDING (geocode-first key)",
	},
]
...
export function yardstickFigure(
	...
	push(
		`<g font-size="10.5">` +
			...
			`<text x="${lx}" y="${ly + 64}" fill="#555">over-merge 109 → 76,</text>` +
