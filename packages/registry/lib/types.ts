...
export interface SourceRecord {
	 ...
	 *
	 * Anything that helps tell two records apart or confirm they're the same beyond
	 * name/org/address/phone (an authorized-official name, a provider taxonomy, a license number…).
	 *
