...
export const TIGERClassCode = {
	...
	/**
	 * A circular intersection allowing for continuous movement of traffic at the meeting
	 * of roadways, when the circle is represented as a point.
	 */
	TrafficCircle: "C3062",
	...
	/**
	 * A manmade structure, higher than its diameter, generally used for observation,
	 * storage, or electronic transmission.
	 */
	Tower: "C3071",

	/**
	 * A manmade structure, higher than its diameter, used to transmit light
	 * and possibly sound generally to aid in navigation.
	 */
	...
	/**
	 * A locational marker or monument placed on or near a boundary line to preserve
	...
	/**
	 * A legally defined state- or federally recognized reservation and/or off-reservation
	 * trust land entity (excluding statistical American Indian and Alaska Native areas).
	 */
	AmericanIndianArea: "G2100",

	/**
	 * A legal area held in trust for the benefit of Native Hawaiians by the state of Hawaii,
	...
	/**
	 * A statistical entity identified and delineated by the Census Bureau in consultation
	 * with federally recognized American Indian tribes that have no current reservation,
	 * but had a former reservation in Oklahoma.
	 */
	OklahomaTribalStatisticalArea: "G2140",

	/**
	 * A statistical geographic entity identified and delineated for the Census Bureau
	 * by a state-appointed liaison for a state-recognized American Indian tribe that
	 * does not currently have a reservation and/or lands in trust.
	 */
	StateDesignatedTribalStatisticalArea: "G2150",

	/**
	 * A statistical geographic entity identified and delineated for the Census Bureau
	 * by a federally recognized American Indian tribe that does not currently have
	 * a reservation and/or off-reservation trust land.
	 */
	 ...
	 * Indian reservation and/or off-reservation trust land, delineated by American Indian
	...
	/**
	 * A grouping of adjacent metropolitan and/or micropolitan statistical areas that have
	 * a degree of economic and social integration, as measured by commuting.
	 */
	...
	/**
	 * A county or grouping of counties that is a subdivision of a Metropolitan Statistical
	 * Area containing an urbanized area with a population of 2.5 million or more.
	 */
	MetropolitanDivision: "G3120",

	/**
	 * A grouping of adjacent New England city and town areas that have a degree of economic
	 * and social integration, as measured by commuting.
	 */
	...
	/**
	 * A grouping of cities and towns in New England that is a subdivision of a New England City
	 * and Town Area containing an urbanized area with a population of 2.5 million or more.
	 */
	NewEnglandCityTownDivision: "G3220",

	/**
	 * For the 2020 Census, an urban area will comprise a densely developed core of census
	...
	/**
	 * Relatively permanent statistical subdivisions of a County or equivalent feature delineated
	 * by local participants as part of the Census Bureau's Participant Statistical Areas Program.
	 */
	CensusTract: "G5020",
	...
	/**
	 * A geographic area within which officials provide public elementary grade-level
	 * educational services for residents.
	 */
	ElementarySchoolDistrict: "G5400",

	/**
	 * A geographic area within which officials provide public secondary grade-level
	 * educational services for residents.
	 */
	SecondarySchoolDistrict: "G5410",

	/**
	 * A geographic area within which officials provide public educational services
	 * for all grade levels for residents.
	 */
	...
	/**
	 * A grouping of municipios (county equivalents) defined by Puerto Rico officials
	 * for the purpose of presenting economic census statistical data.
	 */
	...
	/**
	 * A point or area in which the population of military or merchant marine vessels at
	 * sea are assigned, usually being at or near the home port pier.
	 */
	...
	/**
	 * An area used for setting up mobile temporary living quarters (camp) or holding a
	 * camp meeting, sometimes providing utilities and other amenities.
	 */
	Campground: "K1228",

	/**
	 * A facility providing low-cost or free living quarters established by a welfare
	 * or educational organization for the needy people of a district.
	 */
	...
	/**
	 * A facility that serves as a place for the confinement of adult persons in lawful
	 * detention, administered by the federal government or a state government.
	 */
	FederalPenitentiaryStatePrisonPrisonFarm: "K1237",

	/**
	 * A facility that serves as a place for the confinement of adult persons in lawful detention
	 * rather than elsewhere classified or administered by a government of unknown jurisdiction.
	 */
	...
	/**
	 * An area owned and/or occupied by the Department of Defense for use by a branch of
	 * the armed forces (such as the Army, Navy, Air Force, Marines, or Coast Guard),
	 * or a state owned area for the use of the National Guard.
	 */
	...
	/**
	 * A place used by members of government (either federal, state, local, or tribal)
	 * for administration and public business.
	 */
	GovernmentCenter: "K2165",

	/**
	 * An exhibition hall or conference center with enough open space to host public
	 * and private business and social events.
	 */
	...
	/**
	 * Land under the jurisdiction of the U.S. Forest Service or other federal agency,
	 * excluding National Park Service land.
	 */
	NationalForestOtherFederalLand: "K2182",

	/**
	 * A place or area set aside for recreation or preservation of a cultural or natural
	 * resource and under the administration of an American Indian tribe.
	 */
	TribalParkForestRecreationArea: "K2183",

	/**
	 * A place or area set aside for recreation or preservation of a cultural
	 * or natural resource and under the administration of a state government.
	 */
	StateParkForestRecreationArea: "K2184",

	/**
	 * A place or area set aside for recreation or preservation of a cultural
	 * or natural resource and under the administration of a regional government.
	 */
	RegionalParkForestRecreationArea: "K2185",

	/**
	 * A place or area set aside for recreation or preservation of a cultural
	 * or natural resource and under the administration of a county government.
	 */
	CountyParkForestRecreationArea: "K2186",

	/**
	 * A place or area set aside for recreation or preservation of a cultural or natural resource
	 * and under the administration of a minor civil division (town/township) government.
	 */
	CountySubdivisionParkForestRecreationArea: "K2187",

	/**
	 * A place or area set aside for recreation or preservation of a cultural
	 * or natural resource and under the administration of a municipal government.
	 */
	...
	/**
	 * A place or area set aside for recreation or preservation of a cultural
	 * or natural resource and under the administration of some other type of government
	 * or agency such as an independent park authority or commission.
	 */
	...
	/**
	 * One or more manufacturing establishments within an area zoned for fabrication,
	 * construction, or other similar trades.
	 */
	...
	/**
	 * The area of an airport adjusted to include whole tabulation blocks used
	 ...
	 * control, used to transport fluid (e.g., crude oil, natural gas), especially over great distances.
	 */
	Pipeline: "L4010",
	...
	/**
	 * A conveyance that transports passengers or freight in carriers suspended from cables
	 * and supported by a series of towers.
	 */
	AerialTramwaySkiLift: "L4031",

	/**
	 * A man-made barrier enclosing or bordering a field, yard, etc., usually made of posts
	 * and wire or wood, used to prevent entrance, to confine, or to mark a boundary.
	 */
	FenceLine: "L4110",
	...
	/**
	 * A cadastral boundary line separating two distinct real property parcels
	 * or a Public Land Survey System or equivalent survey line.
	 */
	...
	/**
	 * A legal/statistical boundary line that does not correspond to a shoreline
	 * or other visible feature on the ground.
	 */
	...
	/**
	 * A road that allows controlled access from adjacent roads onto a limited access highway,
	...
	/**
	 * A path that is used for manual or small, motorized bicycles, being either too
...
export type TIGERClassCode = (typeof TIGERClassCode)[keyof typeof TIGERClassCode]
