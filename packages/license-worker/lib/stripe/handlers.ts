...
/**
 * The invoice a charge paid. A charge no longer names its invoice. the link runs through
 * the PaymentIntent, and the invoice-payments list is the one query that answers it.
 */
