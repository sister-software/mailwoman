 ...
 *
 * Its output is a report rather than a verdict. An empty `unresolved` list means this pass found nothing it could not
 * read, which is not a statement that any artifact is cleared for any use.
 */
