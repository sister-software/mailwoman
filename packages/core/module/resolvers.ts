 ...
 * its own data files (`resolvePackagePath("mailwoman", "eval-harness", "baselines.json")`) and how a test names a
 * fixture without walking `..` up from wherever the test sits.
 *
