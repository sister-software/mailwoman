...
- **entrance.txt**: string indicating an entrance, usually the word "entrance" and its appropriate abbreviations.
...
- **staircase.txt**: strings indicating a staircase, usually the word "staircase" or "stair".
