 ...
 * supplement their corpus rows with an Overture sample so each owns its own format shape. the
 * format then stops being discriminative and the model falls back to the linguistic n-grams.
