...
export interface RunChunkProcessOptions {
	 ...
	 *
	 * A build whose ranges are identifiable should pass one: it is the difference between
	 * knowing which rows are unaccounted for and knowing only that some are.
