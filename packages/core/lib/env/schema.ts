...
export const PublicEnvSchema = z
	.object({
		 ...
		 */
		MW_LOCALE: z.string().min(1).optional().meta({
			title: "Default locale",
			description: "Operator locale override used when a request supplies no locale.",
		}),
...
export const PrivateEnvSchema = z
	.object({
		...
		SEC_EDGAR_USER_AGENT: z.string().optional().meta({
