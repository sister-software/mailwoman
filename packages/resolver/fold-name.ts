 ...
 *
 *   `@mailwoman/codex`'s `foldName` (`packages/codex/normalize.ts`) is a near twin and is also
 ...
 * halves of one comparison on different keys. Order is load-bearing: after the class filter the strip is a no-op.
 *
