 ...
 *
 * A bare name the parser tagged `locality` can name a country ("Japan", "China" — single
 * country names are out of the parser's training distribution), and the locality placetype
