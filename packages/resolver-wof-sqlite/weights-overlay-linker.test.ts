 ...
 *
 *   Pins for the shared dev-weights freshness machinery (#1734). The sidecar contract is the part worth pinning: a
...
import { md5FileWithSidecar } from "./weights-overlay-linker.ts"
