...
// `ancestorLineage` takes a live `DatabaseSync` handle + queries `ancestors`/`spr`,
// so it's out of scope for a pure unit test.
// Only the depth helpers below are value-in/value-out.
