...
export class SqliteConventionSource<DB> implements ConventionSource {
	 ...
	 * @param schema The schema name the `address_convention` table lives under (`main` or an
	 * ATTACHed extract name — `WOFSQLitePlaceLookup` auto-detects which extract carries the table).
	 */
