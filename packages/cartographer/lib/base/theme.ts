 ...
 * (`nexus-assets/tiles/basemap-v4.pmtiles`) — `tiles.mailwoman.ai/basemap-v4.json` returns
 * its tilejson, `tiles.mailwoman.ai/basemap-v4/{z}/{x}/{y}.mvt` returns vector tiles.
 */
 ...
 * targets the v4 tile schema (`["==","kind","..."]` filters), matching the basemap-v4 PMTiles on R2.
 */
