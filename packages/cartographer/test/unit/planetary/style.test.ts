...
test.each(["moon", "mars"] as const)("%s: a valid planetary style with labels decluttered by diameter", (body) => {
	...
	// MapLibre 6 requires projection in the style.
	...
	// Terrarium elevation is shaded at render time using the body's palette.
	...
	// Under globe projection, the background layer colors the sphere.
	...
	// Moon and Mars use distinct relief palettes.
