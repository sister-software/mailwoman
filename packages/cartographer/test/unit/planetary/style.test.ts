...
test.each(["moon", "mars"] as const)(
	...
	(body) => {
		...
		// As a map option it is ignored and the body renders flat.
		...
		// Under globe projection a background layer paints the sphere, so this is the
		// body's surface tone rather than the field around it.
