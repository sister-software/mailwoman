...
// Port 7770 is the local origin the public data bucket's cors rule admits,
// the same one the Earth preview uses. on any other port the browser refuses the glyph
// and search-artifact fetches, labels never draw and search never loads.
