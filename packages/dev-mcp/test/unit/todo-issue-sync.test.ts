...
async function fixture(): Promise<{ cwd: PathBuilder; dir: PathBuilder; lock: PathBuilder; payload: PathBuilder }> {
	...
	return { cwd, dir, lock: dir("lock"), payload: dir("payload.json") }
}
