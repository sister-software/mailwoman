...
interface RungReading {
	 ...
	 * and is then refused as a thing-query, while `The Cafe at St Mary's, Oxford` is not.
	 * So a ladder over the two reads as a parse collapse unless the refusal is named here.
	 */
	refused?: string
	/**
