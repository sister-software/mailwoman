...
/**
 * Insert one space after every comma that is directly followed by a letter
 * or digit, unless the comma is a numeric separator.
 *
 * Offset-map-correct: the inserted space maps to the comma.
 */
