 ...
 *
 * An overlay with no block is deliberately exempt: `ProductionScorer`
 * then infers the channels from the ONNX graph.
 * The base supplies the right set, so the overlay gets it for free.
 */
