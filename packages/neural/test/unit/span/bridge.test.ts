 ...
 *
 *   Interface tests for punctuation-gap span bridging (the v4.4.0 corrective). Essential properties:
...
describe("bridgePunctuationGaps", () => {
	...
	it("does NOT merge across separator punctuation (the FR comma class)", () => {
		// "…47110, 9016…" — the model double-labels the house number as a second postcode fragment. the
		// comma is the only thing keeping the spans honest. Never bridge it.
