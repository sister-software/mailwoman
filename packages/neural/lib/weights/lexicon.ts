 ...
 * workaround that only exists because the filename rather than the card, was the interface.
 *
 * The interface is now the card: `requires.<channel>.lexicon` names the artifact the model trained against, and
