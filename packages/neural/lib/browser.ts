...
export * from "#labels"
// Resolution rather than curation: the `browser` condition on this subpath serves a counterpart
// whose every entry point throws, so the value exports below are safe to name from a bundle.
