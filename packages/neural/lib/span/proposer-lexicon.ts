 ...
 * ("Building A" describes the building; "Suite 9" addresses a unit).
 *
 * Inside a bracketed group, these read as annotation content
 * (gold convention 2 of the punctuation-stress eval).
 */
