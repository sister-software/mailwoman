...
/**
 * A second source's attestation of the same name near the same point — the evidence that
 * separates "upstream pruned a real place" from "upstream pruned a ghost".
 */
