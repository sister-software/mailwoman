...
import type { CensusSpan } from "#eval-harness/grammar/census/index"
...
/**
 * Representative full-input receipts printed per feature vector.
 * The JSON row ledger remains complete.
 */
