 ...
 * Naming the recursion is what keeps the walk cast-free — a `children?: unknown` forces every
 * push through an assertion, and the assertion is where a wrong shape stops being a type error.
 */
