 ...
 * Mirroring the resolver's `PLACETYPE_FILTER_GROUPS.locality` is what makes this metric
 * count exactly what the resolver treats as a locality. the bare `=== "locality"` filter
 * it replaced silently discarded correct localadmin hits and under-reported rural US
