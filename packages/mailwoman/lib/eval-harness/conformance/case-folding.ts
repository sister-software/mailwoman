 ...
 * the pair out of this law and into the whitespace one.
 */
 ...
 * Only pairs that are genuinely case-only classify — anything else answers `null`,
 * and the audit reports it as a row that does not belong to this law.
 */
