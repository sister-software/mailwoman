 ...
 *
 *   report only. No output from this command changes a resolve. the ledger exists so an upstream coverage hole is
...
const GazetteerTriage: CommandComponent<typeof spec> = ({ options }) => {
	const state = useCommandTask(async () => {
		...
		// The review queue's head: uncovered and independently attested, most populous first.
		// The rows most likely to be an upstream mistake rather than a real cessation.
		const queue = rows
