 ...
 * Coverage resolution.
 *
 * Res 6 matches what the POI and flood pipelines write, so a reader already keyed to
 * another layer's coverage cells finds these without knowing which build produced them.
 */
