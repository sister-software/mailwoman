 ...
 * The 2026-08-17 first run found 210 databases of which 53 were per-state address-point
 * databases from one builder — so a per-artifact list reads as 53 problems where the
