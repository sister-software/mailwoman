...
/**
 * Neutral dark gray for any tag not in the table above — a future `ComponentTag`
 * addition, or a stray string.
 *
 * The ribbon degrades to an unstyled segment, never a crash or a lookup throw.
 */
