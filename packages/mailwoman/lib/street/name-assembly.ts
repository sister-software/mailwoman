...
/**
 * Street-name component tags — the name-containing subtree of a `street` node (`street.value` alone is the bare base:
...
/**
 * Reassemble the full parsed street name from a street node's name-containing subtree, ordered by span offset. #1041.
 */
