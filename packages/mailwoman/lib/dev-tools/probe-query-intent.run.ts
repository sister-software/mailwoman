 ...
 *
 *   ```bash
 *   node packages/mailwoman/lib/dev-tools/probe-query-intent.run.ts            # the built-in board
 *   node packages/mailwoman/lib/dev-tools/probe-query-intent.run.ts Richmond Cambridge   # ad-hoc queries
 *   ```
 *
