 ...
 *   project-v4.1.0-release + the pinned block in corpus-python/launch/train_remote.py, which is the SOURCE
...
const TRAIN_REMOTE = "corpus-python/launch/train_remote.py"
