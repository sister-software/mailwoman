...
function loadIntl(country: string): Map<string, Centroid> {
	...
	const con = new DatabaseClient<WOFDatabase>(dataRootPath("wof", "postalcode-intl.db"))
...
function loadUs(): Map<string, Centroid> {
	const out = new Map<string, Centroid>()
	const con = new DatabaseClient<WOFDatabase>(dataRootPath("wof", "postalcode-us.db"))
...
function loadGBCodePoint(): Map<string, Centroid> {
	const out = new Map<string, Centroid>()
	const con = new DatabaseClient<WOFDatabase>(dataRootPath("wof", "postalcode-gb-codepoint.db"))
...
function loadNLPC6(): Map<string, Centroid> {
	const out = new Map<string, Centroid>()
	const con = new DatabaseClient<WOFDatabase>(dataRootPath("wof", "postalcode-nl-pc6.db"))
