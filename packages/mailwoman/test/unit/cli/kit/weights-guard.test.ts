...
// A locale with no weights package, which is the whole point: these cases assert
// the not-resolvable path. Therefore, the locale must be one nothing can resolve.
