 ...
 *   with a pinned register would skip this gate and resolve the refused nonsense; measured on the
 *   harness's "Pharmacy near me" → a Hungarian namesake).
 *
 *   Gates: injected classifier only (absent → byte-identical geocoding), no explicit register pin —
...
/**
 * The kinds this gate refuses on. `near_me` additionally needs a focus point no plain geocode carries.
 */
