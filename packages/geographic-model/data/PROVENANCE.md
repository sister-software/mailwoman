...
| File             | Record                                                                                                    | Reading                                                                                                                                                                                                |
| ---------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `relations.json` | `affords`                                                                                                 | `establishment` → `activity`, neither transitive nor symmetric, `defeasible` semantics — an exception qualifies a record rather than falsifying the set                                                |
