...
describe("parseCLIArgs", () => {
	...
	// Half the planet has a negative longitude, and `node:util` refuses a
	// space-separated value that starts with a dash.
	// Both spellings have to reach the same viewport.
