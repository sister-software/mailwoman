...
function plainText(frame: import("@mailwoman/map-tui/frame").MapFrame): string {
...
describe("MapRenderer", async () => {
	...
	it("falls back to an ancestor tile where the archive has no native coverage", async () => {
		...
		// Without the ancestor walk a z12 viewport here renders blank. with it,
		// the z8 fill rasterizes at the z12 projection.
