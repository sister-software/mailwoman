...
/**
 * AST-backed reading-surface heuristic.
 *
 * Warnings name the declaration kind that crossed its threshold.
 * They do not claim a decomposition boundary on the checker's behalf.
 */
