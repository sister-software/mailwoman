...
/**
 * Subset of SAMHSA Treatment Locator CSV columns consulted by the adapter. Column names match the
 * canonical SAMHSA Open Data Foundry export header. `name1` is the venue; `name2` is optional and
 * folded into the venue when present.
 */
