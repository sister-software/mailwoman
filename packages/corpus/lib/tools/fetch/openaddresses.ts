...
`)
	...
	if (collectionID === undefined) {
		...
		// The collection archives stay on raw `fetch` — they stream multi-gigabyte bodies straight
		// to disk, where response caching is nonsense and axios would buffer them in memory.
