 ...
 *
 * Everything else is left as written — see {@link SubVenueSurface.phrase}.
 */
 ...
 *
 * Token-boundary matching for Latin script rather than substring: `Nordterminal` is a real German
 * compound in which `terminal` is a suffix, and a substring test would also fire on `Terminalstraße`.
 * The compound case is a genuine miss and it is the right miss — admitting suffix matches
