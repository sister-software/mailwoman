 ...
 * Particles (upon, super, next, …) stay lowercase mid-name, both between words and between
 * hyphen segments. Each apostrophe-separated segment is capitalized on its own (D'Arcy, James'),
