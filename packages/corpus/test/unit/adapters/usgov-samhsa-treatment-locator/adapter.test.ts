...
const loadRows = () => readCanonicalRows(scratch.path, USGOV_SAMHSA_ADAPTER_ID)

const fixtureCSV = workspacePath("corpus", "fixtures", "usgov-samhsa-treatment-locator", "sample.csv")
