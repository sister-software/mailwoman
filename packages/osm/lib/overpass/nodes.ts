...
/**
 * OSM node tags that disqualify a node from being treated as residential.
 *
 * A node carrying one of these is infrastructure or commercial, whatever else it claims.
 */
