...
import { GeocoderFixture } from "./fixtures/GeocoderFixture.ts"
...
interface E2EFixtures {
	...
	/**
	 * High-level actions on the geocoder page: load, set address, submit, read results.
	 */
	demo: GeocoderFixture
}
...
export const test = base.extend<E2EFixtures>({
	...
	demo: async ({ page, console: consoleFixture }, use) => {
		const fixture = new GeocoderFixture(page, consoleFixture)
		await use(fixture)
	},
})
