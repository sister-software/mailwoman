// FR national rooftop (#1012 + the 2026-07-10 chevaleret closure): with the BAN situs
// extract hosted (street/fr/national/situs.db) and the demo's national street-tier
// fallback wired, a postcode-less FR street address must resolve to its BAN rooftop point
