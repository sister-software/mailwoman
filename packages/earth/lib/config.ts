...
/**
 * The production origins: the public R2 bucket every artifact resolves against, and the tile
 * worker at its custom domain. The sql.js files are staged under `public/` by the build.
 */
