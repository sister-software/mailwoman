...
/**
 * The flag emoji for an ISO 3166-1 alpha-2 country code, formed from the two
...
/**
 * Fill the country-reference fields (ISO 3166 alpha-2, flag, calling code, currency)
 * from a resolved country code.
 *
