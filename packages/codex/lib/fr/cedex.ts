...
/**
 * Find the cedex phrase in a line, if any. Returns the last match — a cedex line
 * places the phrase terminally (NF Z 10-011), and any earlier occurrence in
 * pathological input is more likely a venue name fragment.
 */
