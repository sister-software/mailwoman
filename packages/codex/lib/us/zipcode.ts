...
/**
 * A ZIP (Zone Improvement Plan) Code is a five-digit code assigned by the USPS to
...
/**
 * Given an address string like `"NY"`, `"CA 94016"`, attempts to match the state
 * abbreviation and postcode, if applicable.
 *
