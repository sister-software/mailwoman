 ...
 *
 * The enumeration is a render rather than a walk of the layout structure, because a layout's
 * alternatives and connectors decide which slots are reachable and only the renderer resolves them.
 */
 ...
 * the missing slots starts deriving with no edit here, and one that loses them stops.
 */
