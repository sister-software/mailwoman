...
import { buildThresholds, type GBT, gbtScore, trainGBT } from "@mailwoman/match/gbt"
 ...
 * Same trade recorded in nuts-lookup and timezone-lookup. see core/utils/python-random.ts
...
describe("trainGBT / gbtScore", () => {
	...
	it("round-trips through JSON (the ship-as-a-data-file interface)", () => {
