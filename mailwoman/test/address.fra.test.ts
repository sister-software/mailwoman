...
assert(
	// ---
	"11 Boulevard Saint Germains",
	{
		// ---
		house_number: ["11"],
		street: ["Boulevard Saint Germains"],
	}
)
...
assert(
	// ---
	"Rue Henri Barbusse Paris France",
	{
		// ---
...
assert(
	// ---
	"Rue du Général Leclerc Dunkerque France",
	{
		// ---
...
assert(
	// ---
	"Rue du Capitaine Galinat Marseille France",
	{
		// ---
		street: ["Rue du Capitaine Galinat"],
		locality: ["Marseille"],
		country: ["France"],
	}
)
...
assert(
	// ---
	"4 Cité Du Cardinal Lemoine 75005 Paris",
	{
		// ---
		house_number: ["4"],
		street: ["Cité Du Cardinal Lemoine"],
		postcode: ["75005"],
		locality: ["Paris"],
	}
)
...
assert(
	// ---
	"12 Cité Roland Garros",
	{
		// ---
		house_number: ["12"],
		street: ["Cité Roland Garros"],
	}
)

assert(
	// ---
	"Rue de l'Amiral Galache, Toulouse",
	{
		// ---
		street: ["Rue de l'Amiral Galache"],
		locality: ["Toulouse"],
	}
)
...
assert(
	// ---
	"Rue de l'Inspecteur Alles Paris",
	{
		// ---
		street: ["Rue de l'Inspecteur Alles"],
		locality: ["Paris"],
	}
)
...
assert(
	// ---
	"Rue de l'Empereur Julien Paris",
	{
		// ---
		street: ["Rue de l'Empereur Julien"],
		locality: ["Paris"],
	}
)
...
assert(
	// ---
	"Rue de l'Adjudant Réau Paris",
	{
		// ---
		street: ["Rue de l'Adjudant Réau"],
		locality: ["Paris"],
	}
)
...
assert(
	// ---
	"10 Boulevard Saint-Germains Paris",
	{
		// ---
		house_number: ["10"],
		street: ["Boulevard Saint-Germains"],
...
assert(
	...
	{
		// ---
		street: ["Esplanade de la Liberté"],
	}
)
...
assert(
	...
	{
		// ---
		street: ["Esplanade du Géneral de Gaulle"],
	}
)
