...
export interface LoadSlimOpts {
	...
	/**
	 * Where the sqlite-wasm runtime can find its .wasm asset. Required in browser builds because the default URL is
	 * resolved relative to the worker script, which bundlers usually rewrite.
	 *
